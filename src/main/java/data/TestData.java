...
public class TestData {
    ...
    public final String filepath="src/main/java/data/Customers.txt";
    ...
    public void createTestCar() {
        Car car1 =new Car("MIA-54", "Sedan", "Eco", 5, 2020, "Honda");
        Car car2 =new Car("KLN-203", "SUV", "Lux", 7, 2019, "Toyota");
        Car car3 =new Car("ARB-123", "Sport", "Mid", 5, 2010, "BMV");
        Car car4 =new Car("KRC-121", "Sedan", "Mid", 7, 2018, "FIAT");
        Car car5 =new Car("IST-1453", "Sport", "Lux", 2, 2020, "Mercedes");
        Car car6 =new Car("TX-456", "Sedan", "Eco", 5, 2020, "Renault");
        Car car7 =new Car("KLN-201", "SUV", "Lux", 7, 2019, "Lexus");
    }
